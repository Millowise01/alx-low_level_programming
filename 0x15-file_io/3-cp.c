 ...
 * @file: it show the name of the file buffer is storing chars for.
 ...
 * @fd: it show the file descriptor to be closed.
 */
void close_file(int fd)
{
	int c;
 ...
 * @argc: it show the number of arguments supplied to the program.
